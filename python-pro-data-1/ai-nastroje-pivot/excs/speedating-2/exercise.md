...
Chceme vědět, jaká jsou průměrná hodnocení zábavnosti u protějšků, se kterými se osoba chce nebo nechce sejít. Požádej AI o vytvoření vizualizace. Tentokrát dej AI podrobnější instrukce - řekni, jaký typ grafu by měl použít (např. sloupcový), jaké mají být popisky os, název grafu a barvy sloupců. Zkontroluj kód a podívej se, jak jsou jednotlivé parametry grafu do kódu vloženy.
